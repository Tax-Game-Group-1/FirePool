...
export const BinIcon = forwardRef(function BinIcon({
	className="",fill="", stroke="", ...other
}:ISVGProps, ref:Ref<any>){
	return (
	<svg
...
export const ConfirmTick = forwardRef(function ConfirmTick({
	className="",fill="", stroke="", ...other
}:ISVGProps, ref:Ref<any>){
	return (
	<svg
...
export const CancelCross = forwardRef(function CancelCross({
	className="",fill="", stroke="", ...other
}:ISVGProps, ref:Ref<any>){
	return (
	<svg
